        ...
        <div className={styles.container}>
            <Form onSubmit={onSubmitHandler}>
                ...
                <Form.Group>
                    ...
                    <input name="email" type="email" required={true} className={error === 'invalid_user' && 'error'}></input>
                </Form.Group>

                <Form.Group>
                    <Form.Label>Salasana</Form.Label>
                    <input name="password1" type="password" required={true} className={error === 'password_mismatch' && 'error'}></input>
                    <Form.SubLabel>Salasanan tulee olla vähintään {passLen} merkkiä pitkä.</Form.SubLabel>
                </Form.Group>

                <Form.Group>
                    <label>Anna Salasana Uudelleen</label>
                    <input type="password" name="password2" minLength={passLen} className={error === 'password_mismatch' && 'error'}></input>
                </Form.Group>
