...
function HeroBgImage() {
  ...
  return (
    <div className="absolute top-0 left-0 w-full h-full z-0 bg-index-hero bg-center bg-cover" />
  );
}
...
function IntroGradient() {
  return (
    <div className="z-10 absolute top-0 w-full h-full bg-gradient-to-r from-slate-200 via-slate-200 to-transparent" />
  );
}
