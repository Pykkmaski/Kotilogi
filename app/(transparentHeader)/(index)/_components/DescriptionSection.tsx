export function DescriptionSection() {
  ...
  const Background = () => (
    <div className='bg-kitchen bg-cover bg-center absolute top-0 left-0 w-full h-full opacity-70' />
  );

  return (
    <section className='flex flex-col gap-4 xl:py-0 xs:py-0 bg-primary rounded-3xl overflow-hidden shadow-lg'>
