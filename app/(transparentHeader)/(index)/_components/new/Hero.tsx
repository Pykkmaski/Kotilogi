...
export const Hero = () => {
  return (
    <section className='2xl:h-screen xs:h-[720px] 2xl:px-36 xs:px-4 flex flex-col relative 2xl:items-start py-8 bg-black justify-center bg-[url("/hero_kitchen_background.jpg")] bg-cover'>
      <img
