...
export default function TransparentHeaderLayout({ children }: React.PropsWithChildren) {
  ...
  return (
    <div className='flex flex-col bg-white h-screen'>
      <header className='absolute flex w-full items-center justify-between border-b-white border-b-[1px] py-4 lg:px-48 xs:px-4 z-[20]'>
        <Link
          href='/'
          className='lg:text-2xl xs:text-xl font-bold text-white flex gap-2 items-baseline hover:no-underline'>
          KOTIDOK
