...
export default async function PaymentTermsPage() {
  return (
    <main className='text-slate-500 lg:px-32 xs:px-2 pt-8 h-full pb-10'>
      ...
      <p>
        Sähköposti: kotidok.service@gmail.com
        <br />
        Puhelin: 0451310749
        <br />
        Postiosoite: Timontie 13, 65300 Vaasa
        <br />
        <br />
      </p>
      ...
      <p>
        Tilattavat tuotteet lisätään automaattisesti seuraavien toimintojen yhteydessä ostoskoriin:
        <br />
        <br />
        -Talon lisäys
        <br />
