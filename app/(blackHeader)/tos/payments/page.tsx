...
export default async function PaymentTermsPage(){
    return (
        <main className="text-slate-500 lg:px-32 xs:px-2 pt-8 h-full pb-10">
            ...
            <p>
                Kotidok Oy 3426507-4 (jäljempänä verkkokauppa) myy tuotteita yksityishenkilöille Suomeen.<br/> 
            ...
            <p>
                ...
                Käytettävissä ovat seuraavat maksutavat: Osuuspankki, Nordea, Danske Bank, Oma Säästöpankki, Säästöpankki, Aktia, Paikallisosuuspankit, S-Pankki, Handelsbanken, Ålandsbanken. <br/><br/>
                {
                    /**
