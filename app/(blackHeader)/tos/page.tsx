  ...
  return (
    <main className='text-slate-600 [&_p]:mb-[3rem]'>
      <Padding>
        ...
        <p>
          Palvelu toimitetaan ”sellaisena kuin se on”. Palveluntarjoaja ei anna mitään suoranaisia
          tai välillisiä takuita palvelun toiminnasta tai ominaisuuksista eikä takaa, että palvelu
          toimii käyttökatkoitta ja/tai virheettömästi. Palvelu on kuitenkin lähtökohtaisesti
          käytettävissä 24 tuntia vuorokaudessa. Lisäksi Palveluntarjoaja pyrkii mahdollisuuksien
          mukaan tiedottamaan palvelussa tapahtuvista asiakkaan kannalta olennaisista katkoksista
          tai muista häiriöistä etukäteen ja suorittamaan palvelun ylläpitoon liittyvät toimenpiteet
          muutoinkin siten, että ne haittaavat palvelun käyttöä mahdollisimman vähän.
        </p>
        ...
        <p>
          ...
          mahdollistavat tiedot ovat päätyneet kolmannen haltuun asiakkaan huolimattomuudesta
          johtuen. palveluntarjoaja arvioi palvelun uudelleen avaamisen mahdollisuuden
          tapauskohtaisesti. Palveluntarjoajalla on oikeus poistaa tili ja asiakkaan palvelussa
          syöttämät tiedot, kun asiakkaan tili on ollut lukittuna kolmen kuukauden ajan.
          Palveluntarjoajalla on oikeus poistaa tili ja sillä olevat tiedot välittömästi, jos
          asiakas on käyttänyt palvelua lain, tämän sopimuksen tai hyvän tavan vastaiseen
          toimintaan. Palveluntarjoaja ylläpitää varmuuskopiota asiakkaan palveluun syöttämistä
          tiedoista kuuden kuukauden ajan. Alkuperäisten tietojen katoamiseen vaikuttaneelta
          asiakkaalta voidaan veloittaa varmuuskopion palauttamisesta aiheutuneet kustannukset.
          Palveluntarjoaja poistaa kaikki asiakkaan palveluun syöttämät tiedot kuuden kuukauden
          sisällä Sopimuksen päättymisestä, ellei toisin ole sovittu.
        </p>

        <BigHeading>5. Palvelussa oleva aineisto ja immateriaalioikeudet</BigHeading>
        <p>
          Kaikki immateriaalioikeudet palveluun, sen sisältöön, ominaisuuksiin ja
          toiminnallisuuksiin sekä niiden myöhempiin muutoksiin kuuluvat yksin palveluntarjoajalle.
          Asiakas saa sopimuksen voimassaoloajaksi rajoitetun ei-yksinomaisen oikeuden käyttää
          palvelua omassa käytössä sopimusehtojen mukaisesti. Palvelun ja sen sisällön tai osien
          kopiointi, jäljentäminen, eteenpäin välittäminen, levittäminen tai käyttäminen muuten kuin
          näiden sopimusehtojen mukaisesti on ehdottomasti kielletty. Kaikki asiakkaan palveluun
          syöttämä sisältö kuuluu asiakkaalle. Asiakas myöntää palveluntarjoajalle oikeuden
          käsitellä tällaisia tietoja siinä määrin kuin se on tarpeen palvelun tarjoamiseksi.
        </p>

        <BigHeading>6. Vastuunrajoitukset</BigHeading>
        <p>
          Asiakas on aina itse vastuussa omista tietosuojatoimenpiteistään sekä niiden
          lainmukaisuudesta, tuloksellisuudesta ja mahdollisista seurauksista. Palvelun käyttäminen
          ei siirrä asiakkaan tietosuojavelvoitteita ja -vastuita. Palveluntarjoaja ei ole miltään
          osin vastuussa palvelun perusteella luotujen tietosuojakäytäntöjen tuloksista,
          vaikutuksista tai seurauksista, eikä sitä kohtaan voida esittää näiltä osin mitään
          vaatimuksia. Asiakas käyttää palvelua oman harkintansa mukaan ja omalla vastuullaan.
          Palveluntarjoaja ei vastaa asiakkaan palveluun syöttämien tietojen tai dokumenttien
          tuhoutumisen, katoamisen tai muuttumisen aiheuttamista vahingoista eikä niiden uudelleen
          luomisen aiheuttamista kustannuksista. Palveluntarjoaja ei vastaa miltään osin
          toimenpiteistä, joita asiakkaan palveluksessa olevat tai Asiakkaan muutoin valtuuttamat
          henkilöt suorittavat.
        </p>
