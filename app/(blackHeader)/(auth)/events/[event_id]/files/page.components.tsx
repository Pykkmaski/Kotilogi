    ...
    <Gallery data={files}>
      ...
      <Gallery.DeleteModal>
        <DeleteSelectedItemsModal
          deleteMethod={async (fdata: Kotidok.FileType) => {
      ...
      <Gallery.Body
        ...
        itemComponent={EventFileListItem}
        errorElement={<FileError message='Et ole vielä lisännyt tapahtumalle tiedostoja. Aloita painamalla Lisää Uusi-painiketta.' />}
      />
    </Gallery>
  );
}
