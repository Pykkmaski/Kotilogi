...
export default async function EventLayout({ children, params }) {
  const event = await db("propertyEvents")
      ...
      <LayoutNavBarContainer>
        ...
        <NavBar>
          <div className="text-white">
            <IconLink href={`info`} imageSrc="/icons/info.png">
              Tiedot
            </IconLink>
            <IconLink href={"images"} imageSrc="/icons/image.png">
              Kuvat
            </IconLink>
            <IconLink href={"files"} imageSrc="/icons/copy.png">
              Tiedostot
            </IconLink>
            <NavDivider />
            <IconLink
