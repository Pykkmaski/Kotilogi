      ...
      <Gallery<Kotilogi.EventType> data={events}>
        ...
        <Gallery.DeleteModal>
          <DeleteSelectedItemsModal
            deleteMethod={item => deleteEvent(item.id)}
          />
        </Gallery.DeleteModal>
        ...
        <Gallery.Body
          ...
          itemComponent={props => {
            const consolidationDate = new Date(
              parseInt(props.item.consolidationTime)
            );
            ...
            return (
              <GalleryListItem
                ...
                footerText={
                  new Date(props.item.createdAt).toLocaleDateString("fi-FI") ||
                  "Ei päivämäärää."
                }
                ...
                secondaryHeaderContent={
                  isConsolidated ? (
                    ...
                    <span
                      ...
                      title="Tapahtumaa ei ole vielä vakiinnutettu, ja on muokattavissa."
                    >
