        ...
        <main className="flex flex-col justify-center items-center flex-1 text-slate-600">
            <div className="flex justify-center gap-4">
                <div className="flex flex-col gap-4 flex-3">
                    ...
                    <p className="text-lg">
                        Et ole vielä vahvistanut tiliäsi. Lähetimme sinulle rekisteröitymisesi yhteydessä vahvistuslinkin sähköpostiisi.<br/>
                        Jos et saanut vahvistusviestiä, paina Lähetä uudelleen-painiketta.<br/>
