        ...
        <main className="w-full h-full flex flex-row gap-4 items-center justify-center flex-1">
            <div className="flex justify-center gap-4">
                <div className="flex flex-col gap-4 flex-3">
                    ...
                    <p className="text-lg">
                        Kiitämme kiinnostuksestasi Kotidok:iin. Kotidok:iin tallentamasi talotiedot säilyvät palvelussa, ellet pyydä niiden poistoa.<br/>
                        Jos haluat jatkaa palvelun käyttöä, sinun tulee aloittaa rekisteröityessäsi valitsemasi tilaus.<br/>
                    </p>
