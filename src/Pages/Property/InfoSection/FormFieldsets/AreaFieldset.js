    ...
    return (
        <fieldset disabled={props.disabled}>
            ...
            <Form.Group>
                ...
                <Form.Control id="living-area-input" type="number" name="living_area" defaultValue={property.living_area} onInput={(e) => livingArea.current = e.target.valueAsNumber}></Form.Control>
            </Form.Group>

            <Form.Group>
                <Form.Label>Muut tilat</Form.Label>
                <Form.Control id="other-area-input" type="number" name="other_area" defaultValue={property.other_area} onInput={(e) => otherArea.current = e.target.valueAsNumber}></Form.Control>
            </Form.Group>
