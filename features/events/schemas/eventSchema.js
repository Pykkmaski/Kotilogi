...
const { exteriorCladdingSchema } = require('./exteriorCladdingSchema');
  ...
  .transform((payload, ctx) => {
    ...
    switch (event_type) {
      ...
      case module.exports.EventType.PERUSKORJAUS:
        ...
        } else if (target_type === module.exports.TargetType.ULKOVERHOUS) {
          requiredSchema = exteriorCladdingSchema;
        }
        break;
