            ...
            <Modal.Header>
                <form className="flex flex-col text-slate-500 lg:w-[700px] xs:w-full py-4" id={formId}>
                    <div className="flex flex-col mb-8">
                        <p>
                            Olet poistamassa seuraavia kohteita käytöstä:
                        </p>
                        ...
                        <p>
                            Käytöstä poisto tarkoittaa, ettet enää saa laskua vuosittain veloittavista kohteista Kotidokissa.<br/>
                            Käytöstä poistettuja kohteita ei voi muokata.<br/>
