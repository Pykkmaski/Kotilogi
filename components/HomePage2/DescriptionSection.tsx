export function DescriptionSection() {
  ...
  const Background = () => <div className='bg-kitchen bg-cover bg-center absolute top-0 left-0 w-full h-full opacity-70' />;

  return (
    <section className='flex flex-col gap-4 xl:py-10 xs:py-4 bg-primary'>
      <div className='flex flex-col text-white items-center xl:py-32 xs:py-10 relative gap-4'>
        ...
        <div className='w-full bg-[#0006] py-20 flex flex-col items-center justify-center z-10 xl:px-32 xs:px-4'>
          <h1 className='xl:text-7xl xs:text-3xl mb-20 z-10 font-semibold text-center w-full'>Kaikki yhdessä paikassa</h1>
          <FeaturesList />
        </div>
      </div>
    </section>
