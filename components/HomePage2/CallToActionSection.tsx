...
export function CallToActionSection() {
  const Background = () => {
    return <div className='absolute top-0 left-0 w-full h-full bg-room bg-center bg-cover opacity-50' />;
  };

  return (
    <section className='flex flex-col py-32 bg-secondary'>
      <div className='flex-col flex gap-4 text-primary-text relative py-32'>
        ...
        <div className='flex flex-col z-10 items-center bg-[#0005] py-8'>
          ...
          <p className='text-xl mt-10 w-full text-center text-hero'>Yksittäisen lisätyn talon vuosihinta on 9,90€.</p>
        </div>
      </div>
    </section>
  );
