...
import { ContentCard, RoundedBox } from '../RoundedBox/RoundedBox';
import { ColumnChart, UsageColumnChart } from '../Experimental/Chart/Chart';
...
export function ChartBox(props: ChartBoxProps) {
  ...
  return (
    <div className='flex w-full gap-2' ref={props.ref}>
