...
function useSharedState<PropsT extends InputProps | SelectProps | TextAreaProps>(
  initialInputProps: PropsT
) {
...
export function useSingleInputForm<PropsT extends InputProps | SelectProps | TextAreaProps>(
  initialInputProps: PropsT
) {
  const { status, setStatus, cancelFallbackValue, inputValue } =
