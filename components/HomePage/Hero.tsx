...
export async function Hero(){
    return (
        <section className="flex flex-col gap-5">
            <span className="xl:text-8xl xs:text-5xl text-white xs:text-center xl:text-left">Talosi huoltokirja</span>
            <p className="text-lg mb-5 text-white xs:text-center xl:text-left">
