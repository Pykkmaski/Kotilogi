...
export const yardOwnershipTypes = ['Oma', 'Vuokra', 'Ei Mitään'];

export const buildingMaterials = ['Betoni', 'Tiili', 'Puu', 'Hirsi', 'Muu'];

export const colors = ['Valkoinen', 'Keltainen', 'Sininen', 'Punainen', 'Ruskea', 'Musta', 'Muu'];

export const energyClasses = ['A', 'B', 'C', 'D', 'E', 'F', 'Ei Määritelty'];

const sharedHeatingSystems = ['Öljy', 'Muu'];
...
export const roofMaterials = ['Pelti', 'Huopa', 'Tiili', 'Muu'];

export const roofTypes = ['Harjakatto', 'Pulpettikatto', 'Tasakatto', 'Muu'];
